...
const questions = {
  1: {
    2: {
      title: '1. 기존 문제 한계',
      text: '현행 CBT(컴퓨터 기반 평가)가 가진 고정형 문항 제시 방식의 한계점으로 보기 어려운 것은?',
      options: [
  ...
  2: {
    3: {
      title: '2. CAT 원리',
      text: 'CAT의 기본 진행 과정으로 시작 문항 제시 다음 가장 적절한 것은?',
      options: [
    ...
    1: {
      title: '2. CAT 원리',
      text: 'CAT 시스템을 구동하기 위한 5가지 필수 구성요소에 해당하지 않는 것은?',
      options: [
  ...
  3: {
    3: {
      title: '3. 적용 가능성 및 방안',
      text: '박현 외(2026)의 \'교양 영어 CAT 진단 시스템\' 연구에 대한 설명 및 결과로 옳은 것은?',
      options: [
    ...
    2: {
      title: '3. 적용 가능성 및 방안',
      text: '기초학력진단평가에서 CAT(컴퓨터 적응형 평가)가 제공하는 \'진단적 유용성\'을 가장 잘 설명한 사례는?',
      options: [
    ...
    1: {
      title: '3. 적용 가능성 및 방안',
      text: '다음 중 한국 교육 환경에서 CAT(컴퓨터 적응형 평가)를 도입할 때 가장 적절한 활용 분야는?',
      options: [
  ...
  4: {
    3: {
      title: '4. 한계 및 해결방안',
      text: '베이즈 정리 등을 활용한 매우 정교하고 복잡한 다차원 CAT 알고리즘(MCMC 시뮬레이션 등)은 그 계산량이 너무 방대하여 실시간 온라인 평가 도중 응답 지연을 일으키는 한계가 있었다. 이 연산 속도 한계의 해결 방안은 무엇인가?',
      options: [
    ...
    2: {
      title: '4. 한계 및 해결방안',
      text: '순수 CAT 방식에서 응시자가 느끼는 이전 문항으로 돌아갈 수 없는 불안감을 해결하기 위해 도입할 수 있는 시스템 구조는?',
      options: [
    ...
    1: {
      title: '4. 한계 및 해결방안',
      text: 'CAT에서 특정 문항이 너무 자주 출제되어 보안 문제가 생길 수 있는 한계를 줄이기 위한 방안으로 가장 적절한 것은?',
      options: [
